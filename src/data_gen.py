...
def main() -> int:
    '''
    Andreas and his fucking need for argparsers... kys ;*
    '''
    ...
    argparser.add_argument("seq_type", type=str, choices=[
                           "markov", "random", "repetetive", "identical"], help='specify method to generate from')
    ...
    outdict = foo(args.n_sequences, args.length, fundir[args.seq_type])
...
def repeat_rand_palindrome(length: int, alphabet: Iterable[str], palindrome_length: int) -> str:
    '''
...
fundir: dict[str, Callable[[int, str], str]] = {
    "markov": DNA_markov, "random": tot_rand, "repetetive": repeat_rand, "identical": one_letter}
