...
def one_letter(length: int, alphabet: Iterable) -> str:
    return random.choice(alphabet)*length


def tot_rand(length: int, alphabet: Iterable) -> str:
    s = ""
...
def prob_rand(length: int, alphabet: list, weights: list) -> str:
    s = random.choices(alphabet, weights, k=length)
    return "".join(s)


def repeat_rand(length, rep_length, alphabet: Iterable) -> str:
    rep = ""
...
def repeat_rand_palindrome(length: int, palindrome_length: int, alphabet: Iterable) -> str:
    '''
...
print(repeat_rand_palindrome(20, 10, DNA_alphabet))


def DNA_markov(length) -> str:
    DNA_alphabet = ['A', 'T', 'C', 'G']
